                        ...
                        <div class="panel panel-default" id="votacao" style="background-color: #FFEBCD; height:175px;">
                            <div class="panel-body">
                                ...
                                <div id="botoes" onkeypress="tecla_pressionada(event)" class="form-group col-md-5" align="right">
                                    <button name="bnt1pag3" id="bnt1pag3" type="button" class="btn btn-danger" value="1" style="width: 120px; height: 54x;" onclick="location.href= 'http://192.168.0.104/pesqAtendimento/result.php?questao3=1' ">
                                      <h4><b>Ruim!</b></h4>
                                    </button>
                                </div>
                                <div id="botoes" onkeypress="tecla_pressionada(event)" class="form-group col-md-2">
                                    <button name="btn2pag3" id="btn2pag3" type="button" class="btn btn-warning" value="2" style="width: 120px; height: 54x;" onclick="location.href= 'http://192.168.0.104/pesqAtendimento/result.php?questao3=2' ">
                                      <h4><b>Bom!</b></h4>
                                    </button>
                                </div>
                                <div id="botoes" onkeypress="tecla_pressionada(event)" class="form-group col-md-5" align="left">
                                    <button name="btn3pag3" id="btn3pag3" type="button" class="btn btn-success" value="3" style="width: 120px; height: 54x;" onclick="location.href= 'http://192.168.0.104/pesqAtendimento/result.php?questao3=3' ">
                                      <h4><b>Ótimo!</b></h4>
                                    </button>
                              </div>
