                        ...
                        <div class="panel panel-default" id="votacao" style="background-color: #FFEBCD; height:142px;">
                            <div class="panel-body">
                                ...
                                <div id="botoes" onkeypress="tecla_pressionada(event)" class="form-group col-md-11">
                                    ...
                                    <button name="btn1pag2" id="btn1pag2" type="button" class="btn btn-danger" value="1" onclick="location.href = 'http://192.168.0.104/pesqAtendimento/pagina3.php?questao2=1'"><b>Ruim!</b></button>
                                    <button name="btn2pag2" id="btn2pag2" type="button" class="btn btn-warning" value="2" onclick="location.href = 'http://192.168.0.104/pesqAtendimento/pagina3.php?questao2=2'"><b>Bom!</b></button>
                                    <button name="btn3pag2" id="btn3pag2" type="button" class="btn btn-success" value="3" onclick="location.href = 'http://192.168.0.104/pesqAtendimento/pagina3.php?questao2=3'"><b>Ótimo!</b></button>
                                </div>
